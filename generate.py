...
def generate(args):
    ...
    # add js and css from local directives
    # template_info.add_resource(local_directives.css, CSS_RESOURCE, target=target_path, extra_info='all')
    # source_files.add(local_directives.css)
    # template_info.add_resource(local_directives.js, JS_RESOURCE, target=target_path, extra_info=JS_POSITION_BODY)
    # source_files.add(local_directives.js)
